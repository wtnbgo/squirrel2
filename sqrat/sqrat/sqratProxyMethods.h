...
namespace Sqrat {
	...
	// Arg Count 0
	template <class C, class R>
	inline SQFUNCTION SqProxyFunc(R (*method)(C*)) {
		return &SqProxy<C, R>::Func0;
	}

	// Arg Count 1
	template <class C, class R, class A1>
	inline SQFUNCTION SqProxyFunc(R (*method)(C*, A1)) {
		return &SqProxy<C, R>::template Func1<A1>;
	}

	// Arg Count 2
	template <class C, class R, class A1, class A2>
	inline SQFUNCTION SqProxyFunc(R (*method)(C*, A1, A2)) {
		return &SqProxy<C, R>::template Func2<A1, A2>;
	}

	// Arg Count 3
	template <class C, class R, class A1, class A2, class A3>
	inline SQFUNCTION SqProxyFunc(R (*method)(C*, A1, A2, A3)) {
		return &SqProxy<C, R>::template Func3<A1, A2, A3>;
	}

	// Arg Count 4
	template <class C, class R, class A1, class A2, class A3, class A4>
	inline SQFUNCTION SqProxyFunc(R (*method)(C*, A1, A2, A3, A4)) {
		return &SqProxy<C, R>::template Func4<A1, A2, A3, A4>;
	}

	// Arg Count 5
	template <class C, class R, class A1, class A2, class A3, class A4, class A5>
	inline SQFUNCTION SqProxyFunc(R (*method)(C*, A1, A2, A3, A4, A5)) {
		return &SqProxy<C, R>::template Func5<A1, A2, A3, A4, A5>;
	}

	// Arg Count 6
	template <class C, class R, class A1, class A2, class A3, class A4, class A5, class A6>
	inline SQFUNCTION SqProxyFunc(R (*method)(C*, A1, A2, A3, A4, A5, A6)) {
		return &SqProxy<C, R>::template Func6<A1, A2, A3, A4, A5, A6>;
	}

	// Arg Count 7
	template <class C, class R, class A1, class A2, class A3, class A4, class A5, class A6, class A7>
	inline SQFUNCTION SqProxyFunc(R (*method)(C*, A1, A2, A3, A4, A5, A6, A7)) {
		return &SqProxy<C, R>::template Func7<A1, A2, A3, A4, A5, A6, A7>;
	}

	// Arg Count 8
	template <class C, class R, class A1, class A2, class A3, class A4, class A5, class A6, class A7, class A8>
	inline SQFUNCTION SqProxyFunc(R (*method)(C*, A1, A2, A3, A4, A5, A6, A7, A8)) {
		return &SqProxy<C, R>::template Func8<A1, A2, A3, A4, A5, A6, A7, A8>;
	}

	// Arg Count 9
	template <class C, class R, class A1, class A2, class A3, class A4, class A5, class A6, class A7, class A8, class A9>
	inline SQFUNCTION SqProxyFunc(R (*method)(C*, A1, A2, A3, A4, A5, A6, A7, A8, A9)) {
		return &SqProxy<C, R>::template Func9<A1, A2, A3, A4, A5, A6, A7, A8, A9>;
	}
}
